  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-semibold tracking-tight">Community activity log.</h1>
        <p className="mt-2 max-w-2xl text-sm text-muted-foreground">Audit trail of posts, connections and endorsements across the network.</p>
      </div>
